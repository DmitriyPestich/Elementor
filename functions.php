...
if ( ! function_exists( 'elementor_setup' ) ) :
	/**
	...
	function elementor_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'elementor' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'elementor_custom_background_args', array(
...
add_action( 'after_setup_theme', 'elementor_setup' );
...
function elementor_scripts() {
	...
	wp_enqueue_script( 'elementor-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'elementor-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
